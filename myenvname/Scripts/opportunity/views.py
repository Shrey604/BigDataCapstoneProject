...
class PDF(FPDF):
    def header(self):
        # Logo
        logo = "C:/Users/admin/Desktop/ProjectBackup/logo.jpg"
...
def downloadapplied(request,opportunity):
    ...
    wb.save('C:/Users/admin/Desktop/'+str(opportunity_name)+'.xls')
    return render(request,"downloadallapplied.html",{"filename":'C:/Users/admin/Desktop/'+str(opportunity_name)+'.xls'})
...
def generateNOC_final(request,opportunity):
    if request.POST:
        if request.POST.get('submit')=="Home": 
            ...
            pdf.output("C:/Users/admin/project/trainingandplacement/media/noc/NOC"+str(userid)+".pdf")
            studentobject.NOCgenerated = True
            studentobject.NOCDetails = "C:/Users/admin/project/trainingandplacement/media/noc/NOC"+str(userid)+".pdf"
